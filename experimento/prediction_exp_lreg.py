# Código para realizar experimentos con el modelo de predicción Regresión Logística
import pandas as pd
import mlflow
...
if __name__ == '__main__':
    ...
    mlflow.set_experiment("LR_experiment")  # Define el nombre del experimento en MLflow. Un experimento puede tener varias corridas y se comparan los valores de distintas corridas.
    ...
    for prop in np.arange(0.5, 1.6, 0.1):
        ...
        with mlflow.start_run(run_name=f'test_{proporcion_label_0}'):  # se puede cambiar el nombre entre cada corrida.
